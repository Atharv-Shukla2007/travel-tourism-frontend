    ...
    <nav className="fixed top-0 left-0 right-0 z-50 h-16 glass-nav border-b border-border/50">
      <div className="max-w-7xl mx-auto h-full px-4 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-1">
          ...
          <button
            onClick={signOut}
            className="ml-2 flex items-center gap-2 px-4 py-2 rounded-xl text-sm font-medium text-muted-foreground hover:bg-secondary hover:text-foreground transition-all duration-150"
          >
