      ...
      <div className="relative h-[50vh] overflow-hidden">
        ...
        <div className="absolute inset-0 flex items-end">
          <div className="max-w-7xl mx-auto w-full px-4 pb-8">
            ...
            <h1 className="text-3xl md:text-5xl font-bold tracking-tighter text-primary-foreground">
              {user?.name || "Explorer"}
            </h1>
          </div>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-12 space-y-16">
        ...
        <section>
          <div className="flex items-center justify-between mb-6">
            ...
            <Link to="/explore" className="flex items-center gap-1 text-sm font-medium text-accent hover:underline">
