    ...
    <div className="pt-16">
      <div className="max-w-2xl mx-auto px-4 py-12">
        ...
        <p className="text-muted-foreground mt-2 leading-relaxed">
          Communicate across cultures with our tourism language assistant.
        </p>
        ...
        <div className="mt-8 space-y-4">
          <div>
            ...
            <textarea
              ...
              placeholder='Try "hello", "thank you", "where is the temple"...'
              rows={4}
          ...
          {output && (
            <div className="animate-slide-up">
              ...
              <div className="mt-1.5 w-full px-4 py-4 rounded-xl bg-secondary text-foreground text-lg">
                {output}
              </div>
            </div>
          )}
          ...
          <div className="flex flex-wrap gap-2">
            {Object.keys(mockTranslations).map((phrase) => (
              <button
                ...
                className="px-3 py-1.5 rounded-lg bg-secondary text-sm text-muted-foreground hover:text-foreground transition-colors capitalize"
              >
                {phrase}
              </button>
            ))}
